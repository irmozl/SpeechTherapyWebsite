...
export default function DKTExplanation() {
	return (
		...
		<div className="max-w-5xl mx-auto rounded-2xl shadow-lg p-8 sm:p-12 bg-customGreen-lightest hover:shadow-xl transition">
		  <div className="flex flex-col items-center text-center">
			<div className="bg-customGreen-light p-4 rounded-full shadow mb-6">
			  <MessageCircle className="h-10 w-10 text-customGreen-darkest" />
			</div>
